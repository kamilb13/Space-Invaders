...
int main() {
    ...
    ALLEGRO_BITMAP* bitmap = al_load_bitmap("C:/Users/KOMPUTER/Desktop/ALLEGRO GRY/PNGsy/space-ship_3.png");
    ALLEGRO_BITMAP* enemy_bitmap = al_load_bitmap("C:/Users/KOMPUTER/Desktop/ALLEGRO GRY/PNGsy/ufo.png");
